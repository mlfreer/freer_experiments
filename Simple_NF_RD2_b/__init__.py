...
class C(BaseConstants):
    ...
    outcomes[0] = [1, 2, 1, 1, 1]
    outcomes[1] = [2, 2, 0, 0, 0]
    outcomes[2] = [1, 0, 0, 0, 0]
    outcomes[3] = [1, 0, 0, 0, 0]
    outcomes[4] = [1, 0, 0, 0, 1]
...
class Voting(Page):
    template_name = './Simple_NF_RD2/Voting_GER.html'
    form_model = 'player'
    form_fields = ['vote']
...
class Results(Page):
    template_name = './Simple_NF_RD2/Results_GER.html'
    def vars_for_template(player):
