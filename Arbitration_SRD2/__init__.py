...
Strictly range dominant mechanism with veto (SRD2).
"""
...
class Voting(Page):
    template_name = './Arbitration_SRD2/Voting_DE.html'
    form_model = 'player'
    form_fields = ['veto_1']
...
class Results(Page):
    template_name = './Arbitration_SRD2/Results_DE.html'
    def vars_for_template(player):
